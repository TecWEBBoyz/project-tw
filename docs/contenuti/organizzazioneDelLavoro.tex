...
\begin{itemize}
    ...
    \end{itemize}
    \item Gestione pagine utenti autenticati
    \begin{itemize}
        \item Prenota Servizio (selezione data e orario per un servizio fotografico)
        \item Profilo utente (gestione prenotazioni effettuate)
    \end{itemize}
