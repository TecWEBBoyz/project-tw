...
\begin{itemize}
    \item Viene identificato il tipo MIME (ad esempio, JPEG o PNG) per determinare come gestire il file;
    \item Sono generate quattro versioni ridimensionate dell'immagine originale, rispettivamente al 5\%, 25\%, 50\% e 75\% della dimensione originale;
