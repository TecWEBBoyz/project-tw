\section{SEO}
Per garantire un efficacie posizionamento nelle SERP, sono state adottate le seguenti strategie:
\begin{itemize}
    \item Inserimento di keyword pertinenti all'interno del codice HTML per ottimizzare la rilevabilità della pagina;
    ...
    \item Implementazione di pagine di errore dedicate per una migliore esperienza utente.
\end{itemize}